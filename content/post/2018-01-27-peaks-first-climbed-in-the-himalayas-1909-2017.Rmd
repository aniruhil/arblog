...
ggplot(tab.04, aes(x = reorder(Summiter, Summits), y = Summits, fill = Summits)) + geom_bar(stat  = "identity") + labs(x = "Summiter", y = "Count", title = "Number of Peaks Summited", subtitle = "(1909-2017)", caption = "Source: The Himalayan Database (2017)") + coord_flip() + theme_minimal() + theme(legend.position = "none")
```
