...
ggplot(data = subset(hocking, !is.na(GH_Inst)), aes(dates, GH_Inst)) +
  geom_line(color = "firebrick") + scale_x_date(date_breaks = "3 weeks") + theme_minimal() + labs(y = "Gage Height (in feet)", x = "Date", title = "The Hocking River, Ohio", subtitle = "(2017 - 2018)", caption = "Source: USGS")
```
