...
library(kableExtra)
DT::datatable(tab.02, colnames = c("Peak", "Height (in meters)", "Expeditions"), options = list(pageLength = 5, dom = 'tip')) 
```
