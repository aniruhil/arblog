criptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
methods.addAwesomeMarkers = function (lat, lng, icon, layerId, group, options, popup, popupOptions, clusterOptions, clusterId, label, labelOptions, crosstalkOptions) {
  ...
  if (!(_jquery2.default.isEmptyObject(lat) || _jquery2.default.isEmptyObject(lng)) || _jquery2.default.isNumeric(lat) && _jquery2.default.isNumeric(lng)) {
    ...
    var df = new _dataframe2.default().col("lat", lat).col("lng", lng).col("layerId", layerId).col("group", group).col("popup", (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
"use strict";
...
var ControlStore = function () {
  ...
  _createClass(ControlStore, [{
    ...
    key: "remove",
    value: function remove(id) {
      if (tpopup).col("popupOptions", popupOptions).col("label", label).col("labelOptions", labelOptions).cbind(options).cbind(crosstalkOptions || {});
...
var DataFrame = functionds.addCircleMarkers = function (lat, lng, radius, layerId, group, options, clusterOptions, clusterId, popup, popupOptions, label, labelOptions, crosstalkOptions) {
  if (!(_jquery2.default.isEmptyObject(lat) || _jquery2.default.isEmptyObject(lng)) || _jquery2.default.isNumeric(lat) && _jquery2.default.isNumeric(lng)) {
...
methods.addRasterImage = function (uri, bounds, opacity, attribution, layerId, group) {
  ...
  function getCanvasSmoothingProperty(ctx) {
    ...
    for (var i = 0; i < candidates.length; i++) {
      if (t0, _jquery2.default)(document).on("mousemove", "*", function (e) {
  ...
  factory: function factory(el, width, height) {
    ...
    return {
      ...
      doRenderValue: function doRenderValue(data, map) {
        ...
        // there.
ypeof ctx[candidates[i]] !== "undefined") {
        return candidates[i];
      }
    }
    return null;
    ...
    getImageData(function (imgData, w, h, mipmapper) {
      try {
        var _ret8 = function () {
          ...
          // The linear reso        if (el.offsetWidth === 0 || el.offsetHeight === 0) {
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in deslution of the tile we're drawing is always 256px per tile unit.
          ...
          if (smoothingProperty || imgRes.x >= 256 && imgRes.y >= 256) {
            ...
            for (var row = sourceStart.y; row < sourceEnd.y; row++) {
              for (var col = sourceStart.x; col < sourceEnd.x; col++) {
                ...
                var i = (row * w + col) * 4;
                var r = imgData[i];
                var g = imgData[i criptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
      ...
      if (ctGroup) {
        (function () {
          if (layer.setStyle) {
            // Need to save this info so we know what to set opacity to later
            layer.options.origOpacity = typeof layer.options.opacity !== "undefined" ? layer.options.opacity : 0.5;
            layer.options.origFillOpacity = typeof layer.options.fillOpacity !== "undefined+ 1];
                var b = imgData[i + 2];
                var a = imgData[i + 3];
...
methods.removeSelect = function () {
  ...
  if (this._selectButton) {
    ...
    this._selectButto" ? layer.options.fillOpacity : 0.2;
          }
