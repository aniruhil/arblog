...
**Note:** If you are running some code I have provided or you have found online and you get a message saying `library(xyz)` not found, go ahead and install that library. 
...
- Now create a folder called **mpa5830**  to store everything you will read, develop, etc. in this course 
- Inside **mpa5830** create two sub-folders called **code** and **data**, respectively. The  folder structure will now be 
...
- Now create a `project` via `File -> New Project`, choose `Existing Directory`, <center><img src = "../images/projects.png", width = 300px></center> and browse to the  **mpa5830** folder  
